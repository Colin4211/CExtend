...
//
//  File:
//      CExtend\Libraries\CExBase\CExBase_Float32.h
//
//  DocTool Settings:
//      <DT_SUB_TOPIC> .
//      <DT_SUB_TOPIC> Libs
...
#ifndef _CExBase_Float32_h_
#define _CExBase_Float32_h_
...
typedef union tagFloat32_Info
{
    ...
    public:
        ...
        CEXTEND_CONSTEXPR_FUNCTION  float_type      get_limits_min( void ) const                {   return (FLT_MIN);                   };
        CEXTEND_CONSTEXPR_FUNCTION  float_type      get_limits_max( void ) const                {   return (FLT_MAX);                   };
        CEXTEND_CONSTEXPR_FUNCTION  int             get_limits_min_exp( void ) const            {   return (FLT_MIN_EXP);               };
        CEXTEND_CONSTEXPR_FUNCTION  int             get_limits_max_exp( void ) const            {   return (FLT_MAX_EXP);               };
        CEXTEND_CONSTEXPR_FUNCTION  int             get_limits_min_10_exp( void ) const         {   return (FLT_MIN_10_EXP);            };
        CEXTEND_CONSTEXPR_FUNCTION  int             get_limits_max_10_exp( void ) const         {   return (FLT_MAX_10_EXP);            };
        CEXTEND_CONSTEXPR_FUNCTION  int             get_limits_mantissa_digits( void ) const    {   return (FLT_MANT_DIG);              };
        CEXTEND_CONSTEXPR_FUNCTION  int             get_limits_digits( void ) const             {   return (FLT_DIG);                   };
